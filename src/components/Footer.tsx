...
/**
 * The site's shared footer — brand-orange band with the logo, legal links and
 * social handles. Used on the home page and the subscription app.
 */
    ...
    <footer className="bg-[#f56215] px-5 py-16">
      ...
      <div className="flex flex-col items-center gap-4">
        ...
        <div className="flex items-center gap-6">
          <a
            href="https://www.instagram.com/sochmat_fitfuel/"
